...
class Appliance_state(object):
    ...
    def __init__(self, appliance_type: str, instance: str, state, PROPERTIES: tuple, thedict: dict,
                 dataset='redd'):
        ...
        self.center_value(state)
        self.id = appliance_type + '.' + instance + '.' + str(state)
...
class Appliance_class():
    ...
    @check_func_input_output_type_static
    def __init__(self, appliance_type: str, bigdict: dict, dataset: str = 'redd',
    ...
    def feed_appliance_state(self, instance: str, state) -> Appliance_state:
        appliance_state = Appliance_state(appliance_type=self.appliance_type, thedict=self.bigdict[instance][state],
                                          instance=instance, state=state, PROPERTIES=self.PROPERTIES,
